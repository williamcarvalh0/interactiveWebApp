...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('flight.xml', 'utf8'); //We are reading in the XML file
    var xsl = fs.readFileSync('flight.xsl', 'utf8'); //We are reading in the XSL file
...
router.post('/post/json', function (req, res) {
    ...
    function appendJSON(obj) {
        ...
        xmlFileToJs('flight.xml', function (err, result) {
            ...
            result.booking.section[obj.sec_n].entree.push({'name': obj.name, 'departingDate': obj.departingDate, 'class': obj.class, 'destination': obj.destination});

            console.log(JSON.stringify(result, null, "  "));

            jsToXmlFile('flight.xml', result, function(err){
...
router.post('/post/delete', function (req, res) {
    ...
    function deleteJSON(obj) {
        ...
        xmlFileToJs('flight.xml', function (err, result) {
            ...
            delete result.booking.section[obj.section].entree[obj.entree];
